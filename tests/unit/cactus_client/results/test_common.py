...
async def test_ResultsEvaluation_passed(assertical_extensions):
    ...
    context.responses.responses.append(generate_class_instance(ServerResponse, seed=1, xsd_errors=None))
    context.responses.responses.append(generate_class_instance(ServerResponse, seed=2, xsd_errors=[]))
...
async def test_ResultsEvaluation_failing_xsd_errors(assertical_extensions):
    ...
    context.responses.responses.append(generate_class_instance(ServerResponse, seed=1, xsd_errors=None))
    context.responses.responses.append(generate_class_instance(ServerResponse, seed=2, xsd_errors=["has error"]))
